...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='CRM <noreply@crm.local>')
...
ZIBAL_PAYMENT_URL = 'https://gateway.zibal.ir/start/{track_id}'
ZIBAL_CALLBACK_URL = config('ZIBAL_CALLBACK_URL', default='http://localhost:8000/api/payments/zibal/callback/')

# ─── VoIP ─────────────────────────────────────────────────────────────────────
VOIP_API_BASE_URL = config('VOIP_API_BASE_URL', default='')
VOIP_API_KEY = config('VOIP_API_KEY', default='')
VOIP_WEBHOOK_SECRET = config('VOIP_WEBHOOK_SECRET', default='')

# ─── API Documentation ────────────────────────────────────────────────────────
SPECTACULAR_SETTINGS = {
    'TITLE': 'CRM API',
    'DESCRIPTION': 'Production-ready CRM System API documentation',
    'VERSION': '1.0.0',
